...
int main()
{
    ...
    stDate Date3 = GetSystemDate();

    cout << "\nDifference is: "
        << GetDifferenceInDays(Date1, Date3, false) 
        - GetDifferenceInDays(Date2, Date3, false) << " Day(s)."<<endl;

    cout << "\nDifference (Including End Day) is: "
        << GetDifferenceInDays(Date1, Date3, true) 
        - GetDifferenceInDays(Date2, Date3, true) << " Day(s)."<<endl;
}
