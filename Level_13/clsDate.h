...
class clsDate
{
    ...
    public:
        ...
        static string GetSystemDateTimeString()
        {
            ...
            string FullDate = "";
            FullDate = FullDate + to_string(Day) + "/" ;
            FullDate = FullDate + to_string(Month) + "/" ;
            FullDate = FullDate + to_string(Year) + " - " ;
            if(Hour < 10)
            {
                FullDate = FullDate + "0" + to_string(Hour) + ":";
            }
            else
            {
                FullDate = FullDate + to_string(Hour) + ":";
            }

            if(Minute < 10)
            {
                FullDate = FullDate + "0" + to_string(Minute) + ":";
            }
            else
            {
                FullDate = FullDate + to_string(Minute) + ":";
            }
            
            if(Second < 10)
            {
                FullDate = FullDate + "0" + to_string(Second);
            }
            else
            {
                FullDate = FullDate + to_string(Second);
            }
            return FullDate;
        }
